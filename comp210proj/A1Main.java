...
public class A1Main {
    public static void main(String[] args) {
        ...
        Summer oddInt = new comp210proj.Summer(30);
        comp210proj.Summer evenInt = new comp210proj.Summer(30);
    ...
    static void printStats (comp210proj.Summer evenSummer, comp210proj.Summer oddSummer) {
